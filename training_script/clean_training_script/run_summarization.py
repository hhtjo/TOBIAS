...
====================================================================================
******************************** MAIN CHANGES **************************************
Modified for use with the NEWTS dataset with no model modifications.
- Added support for topic prompts
- Added Topic Score metric
- Added BLEU and BERTScore metrics
...
os.environ["WANDB_PROJECT"] = "NEWTS_BASELINES"
...
class ModelArguments:
    ...
    num_beams_predict: Optional[list] = field(default=None)
...
class DataTrainingArguments:
    ...
    topic_prompt_column: Optional[str] = field(default=None)
...
def main(args=None):
    ...
    def preprocess_function(examples):
        ...
        for i in range(len(examples[text_column])):
            if examples[text_column][i] and examples[summary_column][i]:
                if data_args.topic_prompt_column is not None:
                    inputs.append(
                        examples[data_args.topic_prompt_column][i]
                        + tokenizer.sep_token
    ...
    if training_args.do_predict:
        ...
        predictions = {}
        for n_beam in model_args.num_beams_predict:
